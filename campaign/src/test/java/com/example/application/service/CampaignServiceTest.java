...
class CampaignServiceTest {
  ...
  void findCampaign() {
    ...
    Campaign expectedCampaign =
        CampaignFactory.create(
            "テスト", LocalDateTime.now().minusDays(1), LocalDateTime.now().plusDays(1), "TEST001");
  ...
  void findNonExistentCampaign() {
    ...
    RuntimeException exception =
        assertThrows(RuntimeException.class, () -> campaignService.findCampaign(number));
  ...
  void multipleRepositoryCalls() {
    ...
    Campaign campaign1 =
        CampaignFactory.create(
            "テスト1", LocalDateTime.now().minusDays(1), LocalDateTime.now().plusDays(1), "TEST001");
    Campaign campaign2 =
        CampaignFactory.create(
            "テスト2", LocalDateTime.now().minusDays(2), LocalDateTime.now().plusDays(2), "TEST002");
